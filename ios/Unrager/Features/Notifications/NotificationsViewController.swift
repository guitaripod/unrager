...
final class NotificationsViewController: UIViewController {
    ...
    private lazy var registration = UICollectionView.CellRegistration<UICollectionViewListCell, String> {
        ...
        guard let notif = self?.items[id] else { return }
        ...
        content.image = Self.badge(symbol: style.symbol, color: style.color)
        ...
        cell.accessories = notif.targetTweetID != nil ? [.disclosureIndicator()] : []
    }
    ...
    private static func badge(symbol: String, color: UIColor) -> UIImage {
